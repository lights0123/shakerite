		...
		<ion-content class="content">
			<div class="padding">
				<ion-text class="text">
					...
					<h1>App</h1>
					<p>
						The Shakerite app is Copyright © {{ year }} Ben Schattinger,
						<smart-link href="https://github.com/lights0123/shakerite/">released</smart-link>
					...
					<dl>
						...
						<dd>
							<p>
								...
								control with You. For purposes of this definition, “control” means (a) the power, direct
					...
					<ol type="a">
						<li>
							<p>
								...
								otherwise exploit its Contributions, either on an unmodified basis, with Modifications,
					...
					<p>
						The licenses granted in Section&nbsp;2.1 with respect to any Contribution become effective for
						each Contribution on the date the Contributor first distributes such Contribution.
					</p>
					...
					<ol type="a">
						<li>
							<p>
								...
								obtain a copy of such Source Code Form by reasonable means in a timely manner, at a
					...
					<h2 id="inability-to-comply-due-to-statute-or-regulation">
					...
					<p>
						<em>Covered Software is provided under this License on an “as is” basis, without warranty of any
							kind, either expressed, implied, or statutory, including, without limitation, warranties
							...
							with You. Should any Covered Software prove defective in any respect, You (not any
							Contributor) assume the cost of any necessary servicing, repair, or correction. This
							disclaimer of warranty constitutes an essential part of this License. No use of any Covered
							Software is authorized under this License except under this disclaimer.</em>
					</p>
					<h2 id="limitation-of-liability">7. Limitation of Liability</h2>
					<p>
						<em>Under no circumstances and under no legal theory, whether tort (including negligence),
					...
					<h3 id="distributing-source-code-form-that-is-incompatible-with-secondary-licenses">
						10.4. Distributing Source Code Form that is Incompatible With Secondary Licenses </h3>
					<p>
					...
					<h2 id="exhibit-a---source-code-form-license-notice">
						Exhibit A - Source Code Form License Notice </h2>
					<blockquote>
						<p>
					...
					<h2 id="exhibit-b---incompatible-with-secondary-licenses-notice">

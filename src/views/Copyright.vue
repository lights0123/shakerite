	...
	<fragment>
		...
		<ion-content class="content">
			<div class="padding">
				<ion-text class="text">
					<h1>Content</h1>
					All content shown in the app is Copyright © {{ year }} The Shakerite, all rights
					reserved, unless otherwise noted.

					<h1>App</h1>
					<p>
						The Shakerite app is Copyright © {{ year }} Ben Schattinger,
						<smart-link href="https://github.com/lights0123/shakerite/"
							>released</smart-link
						>
						under the following license:
					</p>
					<h1 id="mozilla-public-license-version-2.0">
					...
					<dl>
						...
						<dd>
							...
							<ol type="a">
								<li>
									<p>
										that the initial Contributor has attached the notice
							...
							<ol type="a">
								<li>
									<p>
										...
										to, deletion from, or modification of the contents of
										Covered Software; or
									</p>
								</li>
								<li>
					...
					<h3 id="distribution-of-executable-form">
					...
					<h3 id="application-of-additional-terms">
					...
					<h3
						id="distributing-source-code-form-that-is-incompatible-with-secondary-licenses"
					>
